...
from beccatest.worlds.base_world import World as BaseWorld
import beccatest.worlds.world_tools as wtools
...
class World(BaseWorld):
    ...
    def visualize_world(self, brain):
        ...
        fig = plt.figure(13)
        clip = (self.sensors[:len(self.sensors)/2.] -
                self.sensors[len(self.sensors)/2.:] + 1.) / 2.
